...
Movie.destroy = function (movieId) {
  if (Movie.instances[movieId]) {
    ...
    delete Movie.instances[movieId].director._directedMovies[movieId];
    // remove inverse references from all movie.actors
    for (const actorID of Object.keys(Movie.instances[movieId].actors)) {
      delete Movie.instances[movieId].actors[actorID]._playedMovies[movieId];
    }
